    ...
    preview.document.write(`<!doctype html>
      ...
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        .document { position: relative; width: 210mm; min-height: 297mm; margin: 10px auto; padding: 15mm 18mm 7mm; background: #fff; font-size: 10pt; line-height: 1.46; }
        ...
        .signature { width: 125mm; margin: 12mm auto 0; text-align: center; }.signature .place-date { display: inline-flex; justify-content: flex-start; gap: 18mm; margin-bottom: 26mm; text-align: left; }.signature .line { border-top: 1px solid #222; margin-bottom: 4px; }
      ...
      <article class="document">
        ...
        <section class="signature-footer"><section class="signature"><div class="place-date"><span>${valueOf(data, 'cidadeAssinatura')}<br><small>Local</small></span><span>${formatDate(data.get('dataAssinatura'))}<br><small>Data</small></span></div><div class="line"></div><strong>${nameOf(data, 'nome')}</strong><br>Assinatura do(a) Declarante</section>${window.renderMegaDeclaration(valueOf(data, 'cidadeAssinatura'), formatDate(data.get('dataAssinatura')))}</section>
      </article></body></html>`);
