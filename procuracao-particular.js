  ...
  procuracaoParticularForm.addEventListener('submit', (event) => {
    ...
    preview.document.write(`<!doctype html>
      ...
      <style>
        ...
        <section class="signature-footer"><p class="place-date">${valueOf(data, 'cidadeAssinatura')}, ${formattedDate(data.get('dataAssinatura'))}.</p><div class="signature">Assinatura do(a) Outorgante</div></section>
      </article></body></html>`);
