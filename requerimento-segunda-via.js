...
if (requerimentoSegundaViaForm) {
  ...
  requerimentoSegundaViaForm.addEventListener('submit', (event) => {
    ...
    preview.document.write(`<!doctype html>
      ...
      <style>
        @page { size: A4 portrait; margin: 0; }* { box-sizing: border-box; }body { margin: 0; background: #eee; color: #121212; font-family: Arial, sans-serif; }.document { position: relative; width: 210mm; min-height: 297mm; margin: 10px auto; padding: 7mm 14mm 6mm; background: #fff; font-size: 8pt; line-height: 1.15; }.logo-symbol { position: absolute; top: 7mm; right: 14mm; width: 19mm; height: 19mm; object-fit: contain; }.heading { margin: 7mm 26mm 3mm 0; border-bottom: 2px solid #111; padding-bottom: 4px; text-align: center; font-size: 13.5pt; }.subtitle { margin: 0 26mm 7px 0; text-align: center; font-size: 7.5pt; font-weight: 700; }.to { margin: 0 0 8px; font-size: 8.4pt; }.section-title { margin: 6px 0 0; font-weight: 700; }.grid { display: grid; border: 1px solid #222; border-bottom: 0; }.grid div { min-height: 25px; padding: 3px 4px; border-right: 1px solid #222; border-bottom: 1px solid #222; }.grid div:last-child { border-right: 0; }.grid b { display: block; margin-bottom: 1px; font-size: 7.1pt; }.owner-one { grid-template-columns: 2fr 1fr; }.owner-two { grid-template-columns: 1.5fr .85fr .9fr; }.owner-three { grid-template-columns: 1fr; }.owner-four { grid-template-columns: 1.12fr 1.08fr .45fr .75fr .9fr; }.vehicle-one { grid-template-columns: .75fr 1.7fr .6fr .6fr; }.vehicle-two { grid-template-columns: 2fr .9fr; }.request { margin: 6px 0 3px; font-size: 8.8pt; }.choice { margin: 2px 0; font-size: 9.5pt; font-weight: 700; line-height: 1.5; }.motives { min-height: 30px; margin-top: 0; padding: 4px; border: 1px solid #222; white-space: pre-wrap; }.legal { margin: 5px 0 7px; font-weight: 700; }.place-date { margin: 0 0 90px; text-align: center; }.signature { width: 80mm; margin: 0 auto 4px; border-top: 1px solid #222; padding-top: 3px; text-align: center; font-weight: 700; }.docs { border-top: 2px solid #111; padding-top: 3px; font-size: 6.4pt; line-height: 1.16; }.docs strong { font-size: 6.9pt; }.docs ol { margin: 2px 0 0; padding-left: 15px; }.print-hint { position: fixed; z-index: 10; top: 18px; right: 18px; border: 0; background: #b42313; color: #fff; padding: 12px 16px; font-weight: 700; cursor: pointer; }@media print { body { background: #fff; }.document { width: 210mm; min-height: 297mm; margin: 0; }.print-hint { display: none; } }${window.MEGA_DECLARATION_CSS}
        ...
        <p class="request">Vem, respeitosamente à presença de V. Sa., solicitar a expedição da 2ª (segunda) via do:</p><div class="choice">${documentChoice.includes('CRV –') ? '☒' : '☐'} CRV - Certificado de Registro de Veículo<br>${documentChoice.includes('CRLV –') ? '☒' : '☐'} CRLV - Certificado de Registro e Licenciamento de Veículo</div><p class="request">do citado veículo, pela(s) seguinte(s) razão(ões):</p><p class="section-title">3 - Motivos da Solicitação:</p><div class="motives">${valueOf(data, 'motivos')}</div><p class="legal">Responsabilizo-me, sob as penas da Lei Civil e Criminal, pela presente requisição.</p><p>Nestes termos, pede deferimento.</p>
        <section class="docs"><strong>Documentação exigida:</strong><br><strong>1 - Segunda Via de CRV / CRLV:</strong><ol><li>Fazer vistoria do veículo;</li><li>Cópia da Carteira de Identidade e CPF ou CNH válida do proprietário, juntamente com os originais para conferência;</li><li>Comprovante de endereço - cópia e original;</li><li>Reconhecer firma da assinatura do requerente/representante legal, por autenticidade.</li></ol><p><strong>OBS:</strong> Em casos de procuração, seguir ainda as orientações para serviços com procuração.</p></section><section class="signature-footer"><p class="place-date">${valueOf(data, 'cidadeAssinatura')}, ${formattedDate(data.get('dataAssinatura'))}.</p><div class="signature"><strong>${nameOf(data, 'proprietario')}</strong><br>Requerente</div>${window.renderMegaDeclaration(valueOf(data, 'cidadeAssinatura'), formattedDate(data.get('dataAssinatura')))}</section>
      </article></body></html>`);
